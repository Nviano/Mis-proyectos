...
import FormStaffStyle from "assets/jss/material-kit-react/views/formStaffPage.jsx";

import image from "assets/img/background-login.jpg";

class FormStaffPage extends React.Component {
  constructor(props) {
    super(props);
...
export default withStyles(FormStaffStyle)(FormStaffPage);
